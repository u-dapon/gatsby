        ...
        <article className="sheet">
          ...
          <div className="sheet__inner">
            ...
            <div className="sheet__reaction">
              ...
              <button className={active ? "c-button c-button--active" : "c-button"} onClick={() => setAvtive(active ? false : true)}>
                <svg className="c-button-svg" version="1.1" x="0px" y="0px" style={{ width: "40px", fill: (active ? "rgb(249, 96, 135)" : "#879fbe")}} viewBox="0 0 512 512">
                <g>
                	<g>
                ...
                <span className="c-button-label" style={{fontWeight: "bold", marginTop: "4px", color: (active ? "rgb(249, 96, 135)" : "#879fbe")}}>LIKE</span>
              </button>
